...
export const toHandleTestField = (category, message, { errorMsg }) => {
...
// export const toEditShippingAddress = async (
//   e,
//   categories,
//   userData,
//   { errorMsg },
...
//     addressType === 'billing'
//       ? await userServices.editUser(userData.id, newAddressData)
//       : await userServices.editShippingAddress(userData.id, newAddressData)
//   } catch (err) {
//     console.error(err)
//   }
//   addressType === 'billing' ? getAddress(userData.id) : getAddress()
