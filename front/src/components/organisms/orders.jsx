...
export default function Orders({ className, orders }) {
  const {
    userData,
    usersData,
    getAllOrders,
                ...
                if (newStatus === 'Expédiée' && shippingNumber === '') {
                  ...
                  try {
                    ...
                    const emailDataClient = {
                      customerFirstName: customer._firstName,
                      customerLastName: customer._lastName,
